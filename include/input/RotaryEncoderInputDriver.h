...
class RotaryEncoderInputDriver : public InputDriver
{
  public:
    ...
    static void setSymScrollCallback(void (*cb)(int16_t diff));
  ...
  private:
    ...
    static void (*symScrollCallback)(int16_t diff);

#ifndef ARCH_PORTDUINO
    // ISR called on every pin-change edge so fast spins are never missed
