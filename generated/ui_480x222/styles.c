...
void init_style_main_button_style_MAIN_FOCUSED(lv_style_t *style) {
    lv_style_set_border_color(style, lv_color_hex(0xff2196f3));
    lv_style_set_border_side(style, LV_BORDER_SIDE_RIGHT);
    lv_style_set_border_width(style, 3);
...
void init_style_map_arrow_style_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_bg_opa(style, 0);
    lv_style_set_bg_image_recolor_opa(style, 100);
    lv_style_set_bg_image_opa(style, 100);
...
void init_style_map_arrow_style_MAIN_FOCUSED(lv_style_t *style) {
    lv_style_set_bg_image_recolor_opa(style, 220);
    lv_style_set_bg_image_opa(style, 220);
};

lv_style_t *get_style_map_arrow_style_MAIN_FOCUSED() {
    static lv_style_t *style;
    if (!style) {
        style = (lv_style_t *)lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_map_arrow_style_MAIN_FOCUSED(style);
    }
    return style;
};
...
void add_style_map_arrow_style(lv_obj_t *obj) {
    ...
    lv_obj_add_style(obj, get_style_map_arrow_style_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
};
...
void remove_style_map_arrow_style(lv_obj_t *obj) {
    ...
    lv_obj_remove_style(obj, get_style_map_arrow_style_MAIN_FOCUSED(), LV_PART_MAIN | LV_STATE_FOCUSED);
};
